...
- You can make the GitHub repo and push the node app's code to it before or during the Jenkins setup. See [Create a New Git Repository](#5-create-a-new-git-repository-and-push-code).
